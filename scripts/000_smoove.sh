...
#SBATCH --ntasks=4
#SBATCH --mem=32G
#SBATCH --output=smoove_%j.stdout
#SBATCH --error=smoove_%j.stderr
...
OUTDIR=/gpool/cfiscus/sv_test/results/lumpy
...
# feed into pl
smoove call --outdir "$OUTDIR" --name test --fasta "$REF" -p 1 --genotype "$BAM"
